          ...
          <div class="tab-content">
              ...
              <div class="tab-pane  " id="side2">
                  <div class="list-group list-group-flush ">
                      ...
                      <div class="list-group-item d-flex  align-items-center">
                          <div class="me-3">
                              <span class="avatar avatar-lg brround cover-image" data-image-src="{{ asset('public/assets/img/faces/2.jpg') }}"><span class="avatar-status bg-success"></span></span>
                          </div>
                          <div>
              ...
              <div class="tab-pane  " id="side3">
                  <div class="list-group list-group-flush ">
                      ...
                      <div class="list-group-item d-flex  align-items-center">
                          <div class="me-2">
                              <span class="avatar avatar-md brround cover-image" data-image-src="{{ asset('public/assets/img/faces/2.jpg') }}"><span class="avatar-status bg-success"></span></span>
                          </div>
                          <div class="">
                      ...
                      <div class="list-group-item d-flex  align-items-center">
                          <div class="me-2">
                              <span class="avatar avatar-md brround cover-image" data-image-src="{{ asset('public/assets/img/faces/2.jpg') }}"></span>
                          </div>
                          <div class="">
                              <div class="font-weight-semibold" data-bs-toggle="modal" data-bs-target="#chatmodel">Zula Mclaughin</div>
                          </div>
