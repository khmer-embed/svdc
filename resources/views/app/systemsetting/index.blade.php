        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    @include('app._include.btn_index', ['new' => true, 'trash' => true, 'import' => true, 'active' => true])
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="card-header">
            ...
            <form class="frmsearch-{{ $obj_info['name'] }}">
                ...
                <div class="form-row" style="font-size: 11px">
                    ...
                    <div class="form-group col-md-4">
                        @php
                            $customertype_id = request()->get('customertype_id');
                            $select = isset($customertype_id) ? $customertype_id : [];
                        @endphp
                        <label for="customertype_id">Type</label>
                        <select multiple="multiple" class="form-control form-select input-sm multiple-select2"
                            name="customertype_id[]" id="customertype_id">
                            <option value='0'>@lang('dev.retailer')</option>
                            {!! cmb_listing($customertype, $select, '', '') !!}
                        </select>
                    </div>
