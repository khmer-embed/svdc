                ...
                let item = ` <div class="file-image-1 mediacenter_object" style="margin:10px; ${border}">
                                <div class="product-image">
                                    <a href="file-details.html">
                                        <img src="${model.items[i].filepath}" class="br-5" alt="">
                                    </a>
                                    <ul class="icons">
...
class MediaForListingController {
    ...
    deleteItem = (item_index) => {
        ...
        if(this.model.items.length>=1 && firstToCover==true){
            this.model.items[0].as_cover = true;
        }
        this.view.render(this.model)
    }
    //
...
/////
class MediaForTextboxController {
