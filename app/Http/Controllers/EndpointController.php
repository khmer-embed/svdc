...
{
    //
    private $obj_info = ['name' => 'endpoint', 'routing' => 'admin.controller', 'title' => 'endpoint', 'icon' => '<i class="fas fa-list"></i>'];
    public $args;
    ...
    private $tablename;
    private $columns = [];
    private $fprimarykey = 'endpoint_id';
    ...
    public function __construct(array $args = [])
    {
        ...
        $this->obj_info['title'] = 'Kobo Endpoint'; //__('label.lb09');
    ...
    public function api_store(Request $request, $id = 0)
    {
        ...
        $dataTable = ["contents" => $json_content, "trash" => "no"];
        $labels = [];
        $question_scores = [];
        foreach ($apidata as $key => $value) {
            ...
            /*get score value for Score and Percentage Filed*/
            if (strpos($label, 'tbl') !== false) {
                array_push($question_scores, $value);
            }
            /*end*/
        ...
        /*update score/percentage*/
        /* create Field Score and Percentage*/


        /*end*/

        /*Auto Create Table New Field Follow to KOBO FORM, If those fields still not create*/
